...
// Utility function for selecting elements (still useful if needed)
function $$(selector, context = document) {
  return Array.from(context.querySelectorAll(selector));
}

// The theme switcher functionality has been ported to +layout.svelte,
// so the following lines are no longer needed and can be commented or deleted.
